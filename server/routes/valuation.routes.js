 ...
 * GET  /api/valuations/compare      → compare historical prices for multiple categories
 * GET  /api/valuations/recalculate  → manually trigger full recalculation
 * GET  /api/valuations/:slug        → single category + valuation history
 * GET  /api/valuations/:slug/history → historical data points for charting
...
router.get('/compare',                  valuationController.compareCategories);
router.post('/recalculate',             valuationController.recalculateAll);
router.get('/:slug',                    valuationController.getCategory);
router.get('/:slug/history',            valuationController.getCategoryHistory);
